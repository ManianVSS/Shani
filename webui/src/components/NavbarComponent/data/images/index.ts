...
export default {
  ...
  'color-scheme': { light: colorSchemeLight, dark: colorSchemeDark },
  'error-pages': { light: errorPagesLight, dark: errorPagesDark },
  comments: { light: commentsLight, dark: commentsDark },
  carousels: { light: carouselsLight, dark: carouselsDark },
};
